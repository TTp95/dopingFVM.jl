        ...
        for i in 1:mesh.l1
            if phi.onoff[i]
                ...
                if phi.bounds[i]
                    ...
                    A[id, id] = ac + (ae + aee + aw + aww) - (aew + awe) #ac + aec + awc
                    b[id] += b0
                else
                    A[id, id] = ac + (ae + aee + aw + aww) - (aew + awe) #ac + aec + awc
                end
            ...
            for j in 1:mesh.m1
                if phi.onoff[i,j]
                    ...
                    if phi.bounds[i,j]
                        ...
                        A[id, id] = ac + (ae + aee + aw + aww + an + ann + as + ass) - (aew + awe + ans + asn) # ac + aec + awc + anc + asc
                        b[id] += b0
                    else
                        A[id, id] = ac + (ae + aee + aw + aww + an + ann + as + ass) - (aew + awe + ans + asn) # ac + aec + awc + anc + asc
                    end
                    ...
                    if phi.onoff[i,j,k]
                        ...
                        if (i != 1) && (mesh.l1 != 1) && (phi.onoff[i-1,j,k])
                            ...
                            if (mflux < 0) && (i != 2) && (phi.onoff[i-2,j,k])
                                ...
                                A[id, phi.gIndex[i-2,j,k]] = -1.0 * aww
                        ...
                        if (i != mesh.l1) && (mesh.l1 != 1) && (phi.onoff[i+1,j,k])
                            ...
                            if (mflux < 0) && (i != (mesh.l1-1)) && (phi.onoff[i+2,j,k])
                                ...
                                A[id, phi.gIndex[i+2,j,k]] = -1.0 * aee
                        ...
                        if (j != 1) && (mesh.m1 != 1) && (phi.onoff[i,j-1,k])
                            ...
                            if (mflux < 0) && (j != 2) && (phi.onoff[i,j-2,k])
                                ...
                                A[id, phi.gIndex[i,j-2,k]] = -1.0 * ass
                        ...
                        if (j != mesh.m1) && (mesh.m1 != 1) && (phi.onoff[i,j+1,k])
                            ...
                            if (mflux < 0) && (j != (mesh.m1-1)) && (phi.onoff[i,j+2,k])
                                ...
                                A[id, phi.gIndex[i,j+2,k]] = -1.0 * ann
                        ...
                        if (k != 1) && (mesh.n1 != 1) && (phi.onoff[i,j,k-1])
                            ...
                            if (mflux < 0) && (k != 2) && (phi.onoff[i,j,k-2])
                                ...
                                A[id, phi.gIndex[i,j,k-2]] = -1.0 * abb
                        ...
                        if (k != mesh.n1) && (mesh.n1 != 1) && (phi.onoff[i,j,k+1])
                            ...
                            if (mflux < 0) && (k != (mesh.n1-1)) && (phi.onoff[i,j,k+2])
                                ...
                                A[id, phi.gIndex[i,j,k+2]] = -1.0 * att
                        ...
                        if phi.bounds[i,j,k]
                            ...
                            A[id, id] = ac + (ae + aee + aw + aww + an + ann + as + ass + at + att + ab + abb) - (aew + awe + ans + asn + atb + abt) # ac + aec + awc + anc + asc + atc + abc
                            b[id] += b0
                        else
                            A[id, id] = ac + (ae + aee + aw + aww + an + ann + as + ass + at + att + ab + abb) - (aew + awe + ans + asn + atb + abt) # ac + aec + awc + anc + asc + atc + abc
                        end
