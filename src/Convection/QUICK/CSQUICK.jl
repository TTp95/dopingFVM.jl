...
"""
function _discretize_convection_quick_ end
        ...
        if phi.onoff[i]
            ...
            if (i != 1) && (mesh.l1 != 1) && (phi.onoff[i-1])
                ...
                if (mflux >= 0) && (i != mesh.l1) && (phi.onoff[i+1])
                    awc, awe, aw, b1 = _convection_quick_neighbors_(mflux, (mesh.x[i]-(mesh.dx[i]*0.5)), mesh.x[i], mesh.x[i+1], mesh.x[i-1])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i-1]
                    AV[n] = aw
                ...
                elseif (mflux >= 0) && (i == mesh.l1)
                    awc, awe, aw, b1 = _convection_quick_neighbors_(mflux, (mesh.x[i]-(mesh.dx[i]*0.5)), mesh.x[i], (mesh.x[i]+(mesh.dx[i]*0.5)), mesh.x[i-1])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i-1]
                    AV[n] = aw
                ...
                if (mflux < 0) && (i != 2) && (phi.onoff[i-2])
                    aw, aww, awc, b1 = _convection_quick_neighbors_(-1.0*mflux, (mesh.x[i]-(mesh.dx[i]*0.5)), mesh.x[i-1], mesh.x[i-2], mesh.x[i])
                    awc = -1.0 * awc
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i-1]
                ...
                elseif (mflux < 0) && (i == 2)
                    aw, aww, awc, b1 = _convection_quick_neighbors_(-1.0*mflux, (mesh.x[i]-(mesh.dx[i]*0.5)), mesh.x[i-1], (mesh.x[i-1]-(mesh.dx[i-1]*0.5)), mesh.x[i])
                    awc = -1.0 * awc
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i-1]
            ...
            if (i != mesh.l1) && (mesh.l1 != 1) && (phi.onoff[i+1])
                ...
                if (mflux >= 0) && (i != 1) && (phi.onoff[i-1])
                    aec, aew, ae, b2 = _convection_quick_neighbors_(mflux, (mesh.x[i]+(mesh.dx[i]*0.5)), mesh.x[i], mesh.x[i-1], mesh.x[i+1])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i+1]
                    AV[n] = ae
                ...
                elseif (mflux >= 0) && (i == 1)
                    aec, aew, ae, b2 = _convection_quick_neighbors_(mflux, (mesh.x[i]+(mesh.dx[i]*0.5)), mesh.x[i], (mesh.x[i]-(mesh.dx[i]*0.5)), mesh.x[i+1])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i+1]
                    AV[n] = ae
                ...
                if (mflux < 0) && (i != (mesh.l1-1)) && (phi.onoff[i+2])
                    ae, aee, aec, b2 = _convection_quick_neighbors_(-1.0*mflux, (mesh.x[i]+(mesh.dx[i]*0.5)), mesh.x[i+1], mesh.x[i+2], mesh.x[i])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i+1]
                    AV[n] = -1.0 * ae
                ...
                elseif (mflux < 0) && (i == (mesh.l1-1))
                    ae, aee, aec, b2 = _convection_quick_neighbors_(-1.0*mflux, (mesh.x[i]+(mesh.dx[i]*0.5)), mesh.x[i+1], (mesh.x[i+1]+(mesh.dx[i+1]*0.5)), mesh.x[i])
                    n += 1
                    AI[n] = id
                    AJ[n] = phi.gIndex[i+1]
                    AV[n] = -1.0 * ae
            ...
            #Center Coefficent
            if phi.bounds[i]
                @inbounds ac, b0 = _convection_quick_central_(
                    i,
                    velocityU,
                    phi,
                    bounds,
            ...
            if phi.onoff[i,j]
                ...
                if (j != 1) && (mesh.m1 != 1) && (phi.onoff[i,j-1])
                    ...
                    if (mflux >= 0) && (j != mesh.m1) && (phi.onoff[i,j+1])
                        asc, asn, as, b3 = _convection_quick_neighbors_(mflux, (mesh.y[j]-(mesh.dy[j]*0.5)), mesh.y[j], mesh.y[j+1], mesh.y[j-1])
                        n += 1
                        AI[n] = id
                    ...
                    elseif (mflux >= 0) && (j == mesh.m1)
                        asc, asn, as, b3 = _convection_quick_neighbors_(mflux, (mesh.y[j]-(mesh.dy[j]*0.5)), mesh.y[j], (mesh.y[j]+(mesh.dy[j]*0.5)), mesh.y[j-1])
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j-1]
                        AV[n] = as
                    ...
                    if (mflux < 0) && (j != 2) && (phi.onoff[i,j-2])
                        as, ass, asc, b3 = _convection_quick_neighbors_(-1.0*mflux, (mesh.y[j]-(mesh.dy[j]*0.5)), mesh.y[j-1], mesh.y[j-2], mesh.y[j])
                        asc = -1.0 * asc
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j-1]
                    ...
                    elseif (mflux < 0) && (j == 2)
                        as, ass, asc, b3 = _convection_quick_neighbors_(-1.0*mflux, (mesh.y[j]-(mesh.dy[j]*0.5)), mesh.y[j-1], (mesh.y[j-1]-(mesh.dy[j-1]*0.5)), mesh.y[j])
                        awc = -1.0 * asc
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j-1]
                ...
                if (j != mesh.m1) && (mesh.m1 != 1) && (phi.onoff[i,j+1])
                    ...
                    if (mflux >= 0) && (j != 1) && (phi.onoff[i,j-1])
                        anc, ans, an, b4 = _convection_quick_neighbors_(mflux, (mesh.y[j]+(mesh.dy[j]*0.5)), mesh.y[j], mesh.y[j-1], mesh.y[j+1])
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j+1]
                        AV[n] = an
                    ...
                    elseif (mflux >= 0) && (j == 1)
                        anc, ans, an, b4 = _convection_quick_neighbors_(mflux, (mesh.y[j]+(mesh.dy[j]*0.5)), mesh.y[j], (mesh.y[j]-(mesh.dy[j]*0.5)), mesh.y[j+1])
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j+1]
                        AV[n] = an
                    ...
                    if (mflux < 0) && (j != (mesh.m1-1)) && (phi.onoff[i,j+2])
                        an, ann, anc, b4 = _convection_quick_neighbors_(-1.0*mflux, (mesh.y[j]+(mesh.dy[j]*0.5)), mesh.y[j+1], mesh.y[j+2], mesh.y[j])
                        anc = -1.0 * anc
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j+1]
                    ...
                    elseif (mflux < 0) && (j == (mesh.m1-1))
                        an, ann, anc, b4 = _convection_quick_neighbors_(-1.0*mflux, (mesh.y[j]+(mesh.dy[j]*0.5)), mesh.y[j+1], (mesh.y[j+1]+(mesh.dy[j+1]*0.5)), mesh.y[j])
                        anc = -1.0 * anc
                        n += 1
                        AI[n] = id
                        AJ[n] = phi.gIndex[i,j+1]
                ...
                if phi.onoff[i,j,k]
                    ...
                    if (i != 1) && (mesh.l1 != 1) && (phi.onoff[i-1,j,k])
                        ...
                        if (mflux >= 0) && (i != mesh.l1) && (phi.onoff[i+1,j,k])
                            ...
                            alpha = abs(num / den)
                            awc, awe, b1 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                        ...
                        if (mflux < 0) && (i != 2) && (phi.onoff[i-2,j,k])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            aw, aww, b1 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i-1,j,k]
                            AV[n] = -1.0 * aw
                    ...
                    if (i != mesh.l1) && (mesh.l1 != 1) && (phi.onoff[i+1,j,k])
                        ...
                        if (mflux >= 0) && (i != 1) && (phi.onoff[i-1,j,k])
                            ...
                            den = (mesh.x[i] - mesh.x[i-1])
                            alpha = abs(num / den)
                            aec, aew, b2 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i-1,j,k]
                            AV[n] = aew
                        ...
                        if (mflux < 0) && (i != (mesh.l1-1)) && (phi.onoff[i+2,j,k])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            ae, aee, b2 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i+1,j,k]
                            AV[n] = -1.0 * ae
                    ...
                    if (j != 1) && (mesh.m1 != 1) && (phi.onoff[i,j-1,k])
                        ...
                        if (mflux >= 0) && (j != mesh.m1) && (phi.onoff[i,j+1,k])
                            ...
                            alpha = abs(num / den)
                            asc, asn, b3 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                        ...
                        if (mflux < 0) && (j != 2) && (phi.onoff[i,j-2,k])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            as, ass, b3 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j-1,k]
                            AV[n] = -1.0 * as
                    ...
                    if (j != mesh.m1) && (mesh.m1 != 1) && (phi.onoff[i,j+1,k])
                        ...
                        if (mflux >= 0) && (j != 1) && (phi.onoff[i,j-1,k])
                            ...
                            den = (mesh.y[j] - mesh.y[j-1])
                            alpha = abs(num / den)
                            anc, ans, b4 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j-1,k]
                            AV[n] = ans
                        ...
                        if (mflux < 0) && (j != (mesh.m1-1)) && (phi.onoff[i,j+2,k])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            an, ann, b4 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j+1,k]
                            AV[n] = -1.0 * an
                    ...
                    if (k != 1) && (mesh.n1 != 1) && (phi.onoff[i,j,k-1])
                        ...
                        if (mflux >= 0) && (k != mesh.n1) && (phi.onoff[i,j,k+1])
                            ...
                            alpha = abs(num / den)
                            abc, abt, b5 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                        ...
                        if (mflux < 0) && (k != 2) && (phi.onoff[i,j,k-2])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            ab, abb, b5 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j,k-1]
                            AV[n] = -1.0 * ab
                    ...
                    if (k != mesh.n1) && (mesh.n1 != 1) && (phi.onoff[i,j,k+1])
                        ...
                        if (mflux >= 0) && (k != 1) && (phi.onoff[i,j,k-1])
                            ...
                            den = (mesh.z[k] - mesh.z[k-1])
                            alpha = abs(num / den)
                            atc, atb, b6 = _convection_quick_neighbors_(mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j,k-1]
                            AV[n] = atb
                        ...
                        if (mflux < 0) && (k != (mesh.n1-1)) && (phi.onoff[i,j,k+2])
                            ...
                            alpha = abs(num / den)
                            aux_mflux = -1.0 * mflux
                            at, att, b6 = _convection_quick_neighbors_(aux_mflux, alpha)
                            n += 1
                            AI[n] = id
                            AJ[n] = phi.gIndex[i,j,k+1]
                            AV[n] = -1.0 * at
