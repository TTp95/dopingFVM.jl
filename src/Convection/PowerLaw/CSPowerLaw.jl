        ...
        for i in 1:mesh.l1
            if phi.onoff[i]
                ...
                if phi.bounds[i]
                    ...
                    A[id, id] = ac - (ae + aw) #- (ae + aw) + (aec + awc)
                    b[id] += b0
                else
                    A[id, id] = ac - (ae + aw) #- (ae + aw) + (aec + awc)
                end
            ...
            for j in 1:mesh.m1
                if phi.onoff[i,j]
                    ...
                    if phi.bounds[i,j]
                        ...
                        A[id, id] = ac - (ae + aw + as + an) #ac - (ae + aw + as + an) + (aec + awc + anc + asc)
                        b[id] += b0
                    else
                        A[id, id] = ac - (ae + aw + as + an) #ac - (ae + aw + as + an) + (aec + awc + anc + asc)
                    end
                ...
                for k in 1:mesh.n1
                    if phi.onoff[i,j,k]
                        ...
                        if phi.bounds[i,j,k]
                            ...
                            A[id, id] = ac - (ae + aw + as + an + ab + at) #ac - (ae + aw + as + an + ab + at) + (aec + awc + anc + asc + atc + abc)
                            b[id] += b0
                        else
                            A[id, id] = ac - (ae + aw + as + an + ab + at) #ac - (ae + aw + as + an + ab + at) + (aec + awc + anc + asc + atc + abc)
                        end
