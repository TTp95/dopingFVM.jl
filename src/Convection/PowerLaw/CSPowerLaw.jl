            ...
            for j in 1:mesh.m1
                if phi.onoff[i,j]
                    ...
                    if phi.bounds[i,j]
                        ...
                        A[id, id] = ac - (ae + aw + as + an) + (aec + awc + anc + asc)
                        b[id] += b0
                    else
                        A[id, id] = ac - (ae + aw + as + an) + (aec + awc + anc + asc)
                    end
                ...
                for k in 1:mesh.n1
                    if phi.onoff[i,j,k]
                        ...
                        if phi.bounds[i,j,k]
                            ...
                            A[id, id] = ac - (ae + aw + as + an + ab + at) + (aec + awc + anc + asc + atc + abc)
                            b[id] += b0
                        else
                            A[id, id] = ac - (ae + aw + as + an + ab + at) + (aec + awc + anc + asc + atc + abc)
                        end
                ...
                for k in 1:mesh.n1
                    if phi.onoff[i,j,k]
                        ...
                        if phi.bounds[i,j,k]
                            ...
                            A[id, phi.gIndex[i,j,k]] = ac - (ae + aw + as + an + ab + at) + (aec + awc + anc + asc + atc + abc)
                        end
                    end
                end
            end
