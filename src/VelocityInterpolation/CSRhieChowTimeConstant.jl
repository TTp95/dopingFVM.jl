            ...
            Base.Threads.@threads for i in 2:mesh.l1
                if velocity.u.onoff[i-1] && velocity.u.onoff[i]
                    ...
                    elseif (scheme == 2) #CN
                        ...
                        #coef2
                        a = a3 * material.ρ * mesh.vol[i-1]
                        b  = a3 * material.ρ * mesh.vol[i]
                ...
                for j in 1:mesh.m1
                    if velocity.u.onoff[i-1,j] && velocity.u.onoff[i,j]
                        ...
                        elseif (scheme == 2) #CN
                            ...
                            #coef2
                            a = a3 * material.ρ * mesh.vol[i-1,j]
                            b  = a3 * material.ρ * mesh.vol[i,j]
                ...
                for j in 2:mesh.m1
                    if velocity.v.onoff[i,j-1] && velocity.v.onoff[i,j]
                        ...
                        elseif (scheme == 2) #CN
                            ...
                            #coef2
                            a = a3 * material.ρ * mesh.vol[i,j-1]
                            b  = a3 * material.ρ * mesh.vol[i,j]
                    ...
                    for k in 1:mesh.n1
                        if velocity.u.onoff[i-1,j,k] && velocity.u.onoff[i,j,k]
                            ...
                            elseif (scheme == 2) #CN
                                ...
                                b  = a2 * material.ρ * mesh.vol[i,j,k]
                                ...
                                #coef2
                                a = a3 * material.ρ * mesh.vol[i-1,j,k]
                                b  = a3 * material.ρ * mesh.vol[i,j,k]
                    ...
                    for k in 1:mesh.n1
                        if velocity.v.onoff[i,j-1,k] && velocity.v.onoff[i,j,k]
                            ...
                            elseif (scheme == 2) #CN
                                ...
                                #coef2
                                a = a3 * material.ρ * mesh.vol[i,j-1,k]
                                b  = a3 * material.ρ * mesh.vol[i,j,k]
                    ...
                    for k in 2:mesh.n1
                        if velocity.w.onoff[i,j,k-1] && velocity.w.onoff[i,j,k]
                            ...
                            elseif (scheme == 2) #CN
                                ...
                                #coef2
                                a = a3 * material.ρ * mesh.vol[i,j,k-1]
                                b  = a3 * material.ρ * mesh.vol[i,j,k]
