...
"""
function array_coordGradient end

function array_coordGradient(
    ...
    for i in 1:mesh.l1
        if phi.onoff[i]
            ...
            elseif (phi.onoff[i-1]) && (phi.onoff[i+1])
                ...
                den = dx1 + dx2
                b = num / den
                bcord[id] = ((b - a) / mesh.dx[i]) * mesh.vol[i]
...
function array_coordGradient(
    ...
    for i in 1:mesh.l1
        for j in 1:mesh.m1
            if phi.onoff[i,j]
                if (mesh.l1 != 1) && ((coord == 'x') || (coord == 'X'))
                    if (i == 1)
                        id = phi.gIndex[i,j]
                        num = arrayG[i+1,j] - arrayG[i,j]
                        den = 0.5 * (mesh.dx[i] + mesh.dx[i+1])
                        bcord[id] = (num / den) * mesh.vol[i,j]
                    elseif (i == mesh.l1)
                        id = phi.gIndex[i,j]
                    ...
                    elseif (phi.onoff[i-1,j]) && (phi.onoff[i+1,j])
                        ...
                        den = dx1 + dx2
                        b = num / den
                        bcord[id] = ((b - a) / mesh.dx[i]) * mesh.vol[i,j]
                ...
                if (mesh.m1 != 1) && ((coord == 'y') || (coord == 'Y'))
                    ...
                    elseif (phi.onoff[i,j-1]) && (phi.onoff[i,j+1])
                        ...
                        den = dy1 + dy2
                        b = num / den
                        bcord[id] = ((b - a) / mesh.dy[j]) * mesh.vol[i,j]
                ...
                if phi.onoff[i,j,k]
                    if (mesh.l1 != 1) && ((coord == 'x') || (coord == 'X'))
                        if (i == 1)
                            ...
                            den = 0.5 * (mesh.dx[i] + mesh.dx[i+1])
                            bcord[id] = (num / den) * mesh.vol[i,j,k]
                        elseif (i == mesh.l1)
                            id = phi.gIndex[i,j,k]
                        ...
                        elseif (phi.onoff[i-1,j,k]) && (phi.onoff[i+1,j,k])
                            ...
                            den = dx1 + dx2
                            b = num / den
                            bcord[id] = ((b - a) / mesh.dx[i]) * mesh.vol[i,j,k]
                    ...
                    if (mesh.m1 != 1) && ((coord == 'y') || (coord == 'Y'))
                        ...
                        elseif (phi.onoff[i,j-1,k]) && (phi.onoff[i,j+1,k])
                            ...
                            den = dy1 + dy2
                            b = num / den
                            bcord[id] = ((b - a) / mesh.dy[j]) * mesh.vol[i,j,k]
                    ...
                    if (mesh.n1 != 1) && ((coord == 'z') || (coord == 'Z'))
                        ...
                        elseif (phi.onoff[i,j,k-1]) && (phi.onoff[i,j,k+1])
                            ...
                            den = dz1 + dz2
                            b = num / den
                            bcord[id] = ((b - a) / mesh.dz[k]) * mesh.vol[i,j,k]
