...
function _evaluate_bounds!_(
    ...
    if (Boundsvalue.cord == 'w') || (Boundsvalue.cord == 'e') || (Boundsvalue.cord == 'W') || (Boundsvalue.cord == 'E')
        dh = mesh.dx[i]
    elseif (Boundsvalue.cord == 's') || (Boundsvalue.cord == 'n') || (Boundsvalue.cord == 'S') || (Boundsvalue.cord == 'N')
        dh = mesh.dy[j]
    else #Default case
...
function _evaluate_bounds!_(
    ...
    elseif (Boundsvalue.cord == 's') || (Boundsvalue.cord == 'n') || (Boundsvalue.cord == 'S') || (Boundsvalue.cord == 'N')
        dh = mesh.dy[j]
    elseif (Boundsvalue.cord == 'b') || (Boundsvalue.cord == 'B') || (Boundsvalue.cord == 't') || (Boundsvalue.cord == 'T')
        dh = mesh.dz[k]
    else #Default case
        error("Boundary of node i = $(i), j = $(j) - error in cord: $(Boundsvalue.cord)")
    end
